...
export interface CalculatorConfiguration {
  ...
  dealLatitude?: number;               // Latitude coordinate from Google Places
  dealLongitude?: number;              // Longitude coordinate from Google Places
  markerId?: number;                   // ID of the public marker for this deal
