              ...
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '1.5rem' }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    background: strategyMode === 'invest' ? 'var(--hdc-cabbage-pont)' : 'transparent',
                    color: strategyMode === 'invest' ? 'white' : 'hsl(var(--foreground))',
                    fontSize: '1rem',
                    fontWeight: '600',
                    cursor: 'pointer',
                    transition: 'all 0.2s',
                ...
                <button
                  ...
                  style={{
                    ...
                    border: '2px solid var(--hdc-cabbage-pont)',
                    borderRadius: '8px',
                    background: strategyMode === 'shelter' ? 'var(--hdc-cabbage-pont)' : 'transparent',
                    color: strategyMode === 'shelter' ? 'white' : 'hsl(var(--foreground))',
                    fontSize: '1rem',
                    fontWeight: '600',
                    cursor: 'pointer',
                    transition: 'all 0.2s',
